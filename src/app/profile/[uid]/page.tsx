  ...
  return (
    <MainLayout>
      <div className="container mx-auto max-w-4xl py-12">
        ...
        <h3 className="text-2xl font-bold mt-12 mb-6">{user.displayName}'s Posts</h3>
        <div className="space-y-4">
          {userPosts.length > 0 ? (
            ...
            <p className="text-muted-foreground text-center py-8">{user.displayName} hasn't posted anything yet.</p>
          )}
        </div>
      </div>
    </MainLayout>
